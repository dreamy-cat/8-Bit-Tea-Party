...
SYSTEM_B	Загрузчик Perfect Commander, диск пуст для музыки, графики и сборок.
 ...
 - построение сцены игры с учетом плановости объектов и восстановлением фона;
...
Обработка положения главного персонажа от джойстика
...
Перемещен лишний отладочный код. Дополнена функция вывода
...
Протестирован минимальный проигрыватель музыки для
...
Реализована утилита по автоматической конвертации исходной
